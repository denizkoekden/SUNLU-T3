...
namespace Language_en {
  ...
  PROGMEM Language_Str MSG_BED_LEVELING                    = _UxGT("Level");
  PROGMEM Language_Str MSG_LEVEL_BED                       = _UxGT("Auxiliary Level");
  PROGMEM Language_Str MSG_SWITCH_BED                      = _UxGT("AUX Level");
  PROGMEM Language_Str MSG_PRINT_CONFIG                    = _UxGT("Fast Print");


  PROGMEM Language_Str MSG_LEVEL_CORNERS                   = _UxGT("Manual Level");
  ...
  PROGMEM Language_Str MSG_RUNOUT_FILAMENT                = _UxGT("filament");
  PROGMEM Language_Str MSG_RUNOUT_JAMS                    = _UxGT("Jams"); // jams
	PROGMEM Language_Str MSG_LAN_SECLET_EN                   = _UxGT("Language");
  PROGMEM Language_Str MSG_LAN_SECLET_CN                   = _UxGT("Language");
  ...
  //
    ...
    PROGMEM Language_Str MSG_ADVANCED_PAUSE_JAMS           = _UxGT(MSG_3_LINE("Press Button", "to resume print", "Check Filament"));
    PROGMEM Language_Str MSG_ADVANCED_PAUSE_FIAM           = _UxGT(MSG_3_LINE("Press Button", "to resume print", "Check Filament"));       
    ...
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_JAMS          = _UxGT(MSG_3_LINE("Press button", "to heat nozzle", "Check Filament"));     // "Press button to heat nozzle."
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_FIAM          = _UxGT(MSG_3_LINE("Press button", "to heat nozzle", "Check Filament"));     // "Press button to heat nozzle."
