...
namespace Language_zh_CN {
  ...
  PROGMEM Language_Str WELCOME_MSG                         = MACHINE_NAME _UxGT(" Ready.");//("已就绪.");     //" ready."
  ...
  PROGMEM Language_Str MSG_SWITCH_BED                      = _UxGT("调平开关");     //"Level swtich"
  PROGMEM Language_Str MSG_PRINT_CONFIG                    = _UxGT("快速打印");
  ...
  PROGMEM Language_Str MSG_BLTOUCH                         = _UxGT("调平开关");     // "BLTouch"
  ...
  PROGMEM Language_Str MSG_RUNOUT_FILAMENT                 = _UxGT("filament开关");
  PROGMEM Language_Str MSG_RUNOUT_JAMS                     = _UxGT("堵料开关");
  PROGMEM Language_Str MSG_LAN_SECLET_EN                   = _UxGT("语言");
  PROGMEM Language_Str MSG_LAN_SECLET_CN                   = _UxGT("语言");
  ...
  //
    ...
    PROGMEM Language_Str MSG_ADVANCED_PAUSE_JAMS           = _UxGT(MSG_3_LINE("停下按钮", "恢复打印", "请检查耗材"));
    PROGMEM Language_Str MSG_ADVANCED_PAUSE_FIAM           = _UxGT(MSG_3_LINE("停下按钮", "恢复打印", "请检查耗材"));    
    ...
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_JAMS          = _UxGT(MSG_3_LINE("按下按钮来", "加热喷嘴.", "请检查耗材"));     // "Press button to heat nozzle."
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_FIAM          = _UxGT(MSG_3_LINE("按下按钮来", "加热喷嘴.", "请检查耗材"));     // "Press button to heat nozzle."
