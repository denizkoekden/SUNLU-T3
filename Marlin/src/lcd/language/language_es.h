...
namespace Language_es {
  ...
  PROGMEM Language_Str LANGUAGE                            = _UxGT("Español");
  ...
  PROGMEM Language_Str MSG_MEDIA_INSERTED                  = _UxGT("SD insertado");
  PROGMEM Language_Str MSG_MEDIA_REMOVED                   = _UxGT("SD retirado");
  PROGMEM Language_Str MSG_MEDIA_WAITING                   = _UxGT("Esperando al SD");
  PROGMEM Language_Str MSG_SD_INIT_FAIL                    = _UxGT("Fallo al iniciar SD");
  PROGMEM Language_Str MSG_MEDIA_READ_ERROR                = _UxGT("Error lectura SD");
  ...
  PROGMEM Language_Str MSG_CONFIGURATION                   = _UxGT("Configuracion");
  PROGMEM Language_Str MSG_RUN_AUTO_FILES                  = _UxGT("Inicio automático");
  PROGMEM Language_Str MSG_DISABLE_STEPPERS                = _UxGT("Apagar el Motores");
  ...
  PROGMEM Language_Str MSG_AUTO_HOME                       = _UxGT("Inicio Auto");
  PROGMEM Language_Str MSG_AUTO_HOME_X                     = _UxGT("Inicio X");
  PROGMEM Language_Str MSG_AUTO_HOME_Y                     = _UxGT("Inicio Y");
  PROGMEM Language_Str MSG_AUTO_HOME_Z                     = _UxGT("Inicio Z");
  ...
  PROGMEM Language_Str MSG_SWITCH_BED                      = _UxGT("Nivel AUX");
  PROGMEM Language_Str MSG_PRINT_CONFIG                    = _UxGT("Impresion Rapida");
  #if PREHEAT_COUNT
    ...
    PROGMEM Language_Str MSG_PREHEAT_1_END                 = _UxGT("Precal. ") PREHEAT_1_LABEL _UxGT(" Final");
    PROGMEM Language_Str MSG_PREHEAT_1_END_E               = _UxGT("Precal. ") PREHEAT_1_LABEL _UxGT(" Final ~");
    ...
    PROGMEM Language_Str MSG_PREHEAT_1_SETTINGS            = _UxGT("Conf. precal ") PREHEAT_1_LABEL _UxGT(" ");

    PROGMEM Language_Str MSG_PREHEAT_M                    = _UxGT("Precal. $");
    PROGMEM Language_Str MSG_PREHEAT_M_H                  = _UxGT("Precal. $ ~");
    PROGMEM Language_Str MSG_PREHEAT_M_END                = _UxGT("Precal. $ Final");
    PROGMEM Language_Str MSG_PREHEAT_M_END_E              = _UxGT("Precal. $ Final ~");
    PROGMEM Language_Str MSG_PREHEAT_M_ALL                = _UxGT("Precal. $ Todo");
    PROGMEM Language_Str MSG_PREHEAT_M_BEDONLY            = _UxGT("Precal. $ Cama");
    PROGMEM Language_Str MSG_PREHEAT_M_SETTINGS           = _UxGT("Conf. precal. $");
  #endif
  ...
  PROGMEM Language_Str MSG_BED_LEVELING                    = _UxGT("Nivel");
  PROGMEM Language_Str MSG_LEVEL_BED                       = _UxGT("Nivel Auxiliar");
  PROGMEM Language_Str MSG_LEVEL_CORNERS                   = _UxGT("Nivel Manual");
  ...
  PROGMEM Language_Str MSG_RESTORE_DEFAULTS                = _UxGT("Restaurar predeter.");
  ...
  PROGMEM Language_Str MSG_MEDIA_UPDATE                    = _UxGT("Actualizar SD");
  ...
  PROGMEM Language_Str MSG_BUTTON_DONE                     = _UxGT("Terminado");
  ...
  PROGMEM Language_Str MSG_OUTAGE_RECOVERY                 = _UxGT("Apagon");
  PROGMEM Language_Str MSG_MEDIA_MENU                      = _UxGT("Imprimir desde SD");
  PROGMEM Language_Str MSG_NO_MEDIA                        = _UxGT("SD no presente");
  ...
  PROGMEM Language_Str MSG_RELEASE_MEDIA                   = _UxGT("Lanzar SD");
  ...
  PROGMEM Language_Str MSG_ZPROBE_ZOFFSET                  = _UxGT("Offset en Z");
  ...
  PROGMEM Language_Str MSG_INFO_MENU                       = _UxGT("Sobre impresoras");
  ...
  PROGMEM Language_Str MSG_RUNOUT_JAMS                    = _UxGT("Atasco");
