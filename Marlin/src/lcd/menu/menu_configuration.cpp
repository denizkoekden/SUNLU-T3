...
#if ENABLED(FILAMENT_JAMS_SWITCH)
    EDIT_ITEM(bool, MSG_RUNOUT_SENSOR, &test_filament_enable);//MSG_RUNOUT_FILAMENT
	EDIT_ITEM(bool, MSG_RUNOUT_JAMS    , &test_jams_enable);
#endif
