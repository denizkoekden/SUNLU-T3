...
void Filament_Runout_AutoRecovery(void){
 bool ret =false;
	  ...
	  do{ Serial.println("Filament_Runout_AutoRecovery1111");  }while(0);
	  if(ret){  //no  resume print
		  do{ Serial.println("Filament_Runout_AutoRecovery2222");  }while(0);
      ...
      wait_for_confirmation(false, 0);
		  ...
		  do{ Serial.println("Filament_Runout_AutoRecovery3333");  }while(0);
		  //resume_print(0, 0, -retract, 0);
		  
		  }
	  else{  //yes  
		  do{ Serial.println("Filament_Runout_AutoRecovery4444");  }while(0);
...
void resume_print(const_float_t slow_load_length/*=0*/, const_float_t fast_load_length/*=0*/, const_float_t purge_length/*=ADVANCED_PAUSE_PURGE_LENGTH*/, const int8_t max_beep_count/*=0*/, const celsius_t targetTemp/*=0*/ DXC_ARGS) {
  ...
  //*/
  do{ Serial.println("resume_print1111");  }while(0);
  ...
  float temp_acce=planner.settings.acceleration;
  ...
  #endif
  planner.settings.acceleration=temp_acce;
