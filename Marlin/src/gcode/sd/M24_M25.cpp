 ...
 */
void GcodeSuite::M24() {
	//do{ Serial.print("M24_111="); Serial.println(current_position.x); }while(0);
  ...
  //do{ Serial.print("M24_222="); Serial.println(current_position.x); }while(0);
}
...
void GcodeSuite::M25() {
  ...
  //planner.synchronize();
    ...
    //TERN_(DGUS_LCD_UI_SUNLU, MKS_pause_print_move());
	//SUNLU_pause_print_move();
	

    IF_DISABLED(DWIN_CREALITY_LCD, ui.reset_status());
	//do{ Serial.println("M25 here") };while(0);
