...
extern float acceleration_Back;
...
void GcodeSuite::M204() {
  if (!parser.seen("PRST")) {
    ...
    if (parser.seenval('S')) planner.settings.travel_acceleration = planner.settings.acceleration = acceleration_Back = parser.value_linear_units();
