 ...
 */
  ...
  #define SHORT_BUILD_VERSION ""//"sunlu-v2.9"//zb
  #ifdef Internal_Version
    #ifdef HEAT_PIPES_60_W
    #define CURRENT_BUILD_VERSION  "sunlu-v3.42c"
    #else
     #define CURRENT_BUILD_VERSION  "sunlu-v3.41c"
    #endif
  #else
  #define CURRENT_BUILD_VERSION  "sunlu-v3.42"
  #endif
#endif
 ...
 */
   ...
   */
#ifndef WEBSITE_URL
  #define WEBSITE_URL "www.sunlu.com"
#endif
